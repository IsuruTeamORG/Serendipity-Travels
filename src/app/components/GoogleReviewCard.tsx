      ...
      <div className="p-4 gap-5">
        <div className="flex items-center mb-2">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">{googleReview.date}</p>
          </div>
        </div>
...
const GoogleReviewCarousel: React.FC<GoogleReviewCarouselProps> = ({
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="text-3xl font-bold leading-[20px] text-left text-[#004643] mb-4 font-playfair">Excellent</div>
      <div className="text-2xl font-bold text-[#FFD700]">5.2 Google Review</div>
      </div>
