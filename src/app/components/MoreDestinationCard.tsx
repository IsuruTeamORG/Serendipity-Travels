...
<div className="flex items-center justify-center ">
  <div className="grid grid-cols-1  gap-5 ">
    <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl rounded-lg">
      ...
      <div className="absolute inset-0 rounded-xl flex bg-black bg-opacity-25 translate-y-[59%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
